...
from .blueprints.plugins.sticky_messages import sticky_messages_bp
from .blueprints.plugins.custom_commands import custom_commands_bp
...
app.register_blueprint(sticky_messages_bp)
